class WelcomeController < ApplicationController
  ...
  def index
      @which_display = rand(1..14)

    if @which_display == 1
      @display_phrase = "Speaking about women: 'You have to treat 'em like shit.' "
